...
Public Class frmReports
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click   ' Released Items toggle
    ...
    Private Sub LoadGrid()
        Try
            ...
            Label3.Text = ChrW(8369) & Convert.ToDecimal(If(ExecScalar(
                ...
                New String() {"@d1", "@d2", "@s"}, New Object() {DateTimePicker1.Value.Date, DateTimePicker2.Value.Date, "%" & searchText & "%"}), 0)).ToString("N2")
